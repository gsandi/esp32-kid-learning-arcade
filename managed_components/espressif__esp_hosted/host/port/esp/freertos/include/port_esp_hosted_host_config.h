...
/* PlatformIO + IDF 6.0.x: Kconfig slave_select.in not loaded, so Kconfig defaults
 * to SPI transport. CrowPanel P4 uses SDIO (C6 coprocessor). Override here after
 * sdkconfig.h is visible so #undef takes effect. */
#if defined(CONFIG_IDF_TARGET_ESP32P4)
  #undef CONFIG_ESP_HOSTED_SPI_HOST_INTERFACE
  #ifndef CONFIG_ESP_HOSTED_SDIO_HOST_INTERFACE
    #define CONFIG_ESP_HOSTED_SDIO_HOST_INTERFACE 1
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_CLOCK_FREQ_KHZ
    #define CONFIG_ESP_HOSTED_SDIO_CLOCK_FREQ_KHZ 40000
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_BUS_WIDTH
    #define CONFIG_ESP_HOSTED_SDIO_BUS_WIDTH 1
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_SLOT
    #define CONFIG_ESP_HOSTED_SDIO_SLOT 1
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_TX_Q_SIZE
    #define CONFIG_ESP_HOSTED_SDIO_TX_Q_SIZE 20
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_RX_Q_SIZE
    #define CONFIG_ESP_HOSTED_SDIO_RX_Q_SIZE 20
  #endif
  /* GPIO pins: CMD=19 CLK=18 D0=14 D1=15 D2=16 D3=17 RST=32 */
  #ifndef CONFIG_ESP_HOSTED_SDIO_PIN_CMD
    #define CONFIG_ESP_HOSTED_SDIO_PIN_CMD 19
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_PIN_CLK
    #define CONFIG_ESP_HOSTED_SDIO_PIN_CLK 18
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_PIN_D0
    #define CONFIG_ESP_HOSTED_SDIO_PIN_D0 14
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_PIN_D1
    #define CONFIG_ESP_HOSTED_SDIO_PIN_D1 15
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_PIN_D2
    #define CONFIG_ESP_HOSTED_SDIO_PIN_D2 16
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_PIN_D3
  ...
  #endif
  #ifndef CONFIG_ESP_HOSTED_SDIO_RESET_DELAY_MS
...
#else
  /* CrowPanel P4 slave is ESP32-C6; Kconfig slave_select not loaded by PlatformIO */
  #define H_SLAVE_TARGET_ESP32C6 1
